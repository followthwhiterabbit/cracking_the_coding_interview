...
select whatever they would prefer a dog or a cat(and will receive the oldest animal of that type). They 
cannot select which specific aninal they would like. Create the data structures to maintain this system and 
